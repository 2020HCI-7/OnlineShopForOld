...
import DiscountListStore from "../components/discount/discount_list/DiscountListStore"
import DiscountAddStore from "../components/discount/discount_add/DiscountAddStore"
import DiscountManagementStore from "../components/discount/discount_management/DiscountManagementStore"
...
AppDispatcher.register(function (action) {
    switch (action.actionType) {
        ...
        case "REGISTER_HANDLE_CHANGE":
            RegisterStore.handleChange(action.key, action.value)
            break
        case "REGISTER_FINISH_REGISTER":
        ...
        case "COMMODITY_MANAGEMENT_TO_COMMODITY_ADD":
            ...
            break
        /*DiscountList*/
        case "DISCOUNT_LIST_INIT":
            DiscountListStore.init(action.initInfo)
            break
        case "DISCOUNT_LIST_DELETE":
            DiscountListStore.deleteDiscount(action.discount)
            break
        /*DiscountAdd*/
        case "DISCOUNT_ADD_INIT":
            DiscountAddStore.init(action.initInfo)
            DiscountAddStore.emitChange()
            break
        case "DISCOUNT_ADD_HANDLE_CHANGE":
            DiscountAddStore.handleChange(action.key, action.value)
            DiscountAddStore.emitChange()
            break
        case "DISCOUNT_ADD_FINISH_DISCOUNT_ADD":
            DiscountAddStore.finishDiscountAdd()
            DiscountAddStore.emitChange()
            break
        /*DiscountManagement*/
        case "DISCOUNT_MANAGEMENT_INIT":
            DiscountManagementStore.init(action.initInfo)
            DiscountManagementStore.emitChange()
            break
        case "DISCOUNT_MANAGEMENT_TO_DISCOUNT_MODIFY":
            DiscountManagementStore.toDiscountModify(action.userId)
            DiscountManagementStore.emitChange()
            break
        case "DISCOUNT_MANAGEMENT_TO_DISCOUNT_LIST":
            DiscountManagementStore.toDiscountList()
            DiscountManagementStore.emitChange()
            break
        case "DISCOUNT_MANAGEMENT_TO_DISCOUNT_ADD":
            DiscountManagementStore.toDiscountAdd()
            DiscountManagementStore.emitChange()
            break
        /*ShopModify*/
