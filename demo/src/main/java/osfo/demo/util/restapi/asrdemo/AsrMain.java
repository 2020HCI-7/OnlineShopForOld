package osfo.demo.util.restapi.asrdemo;


import osfo.demo.util.restapi.common.ConnUtil;
import osfo.demo.util.restapi.common.DemoException;
import osfo.demo.util.restapi.common.TokenHolder;
import osfo.demo.util.restapi.common.TokenHolder;
...
public class AsrMain {
    ...
    private final String APP_KEY = "kaDP8iEaUwz0GeT0SMFUzaAz";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "dumO6j81gGcG6ycRvHhVzmR73fLAnIfT";

    // 需要识别的文件
    private String FILENAME = "D:\\github\\speech-demo-master\\speech-demo-master\\rest-api-asr\\bash_shell\\16k.pcm";
